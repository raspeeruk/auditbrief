...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/guides/seo-audit-checklist`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${base}/guides/how-to-do-seo-audit`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
